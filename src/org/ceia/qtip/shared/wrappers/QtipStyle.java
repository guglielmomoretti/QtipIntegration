...
public class QtipStyle {
    ...
    private Boolean useDefaultStyle = null;
    private int width = -1;
     ...
     * override max/min width styles! Change those in the CSS file provided.
     * <br>
     * <br>
     ...
     * tooltip. Can be any valid width CSS value. Please note that this does not
     * override max/min height styles! Change those in the CSS file provided.
     * <br>
     * <br>
