...
public class AbstractQtipVisibilityManager extends JavaScriptObject {

	protected AbstractQtipVisibilityManager() {
	 ...
	 * {@link QtipVisibilityEventList} Helper Class.<br>
